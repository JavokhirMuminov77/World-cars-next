						...
						<Stack className={'property-info-config'}>
							<Stack className={'info'}>
								<Stack className={'left-box'}>
									...
									<Stack className={'top-box'}>
										<Typography className={'city'}>{property?.propertyTypes}</Typography>
							...
							<Stack className={'images'}>
								<Stack className={'main-image'}>
									<img
										src={slideImage ? `${REACT_APP_API_URL}/${slideImage}` : '/img/banner/mercadess-red.webp'}
										alt={'main-image'}
									/>
								</Stack>
						...
						<Stack className={'property-desc-config'}>
							<Stack className={'left-config'}>
								<Stack className={'options-config'}>
									...
									<Stack className={'option'}>
										<Stack className={'svg-box'}>
											<img src={'/img/icons/seat.png'} />
										</Stack>
										<Stack className={'option-includes'}>
											<Typography className={'title'}>Seat</Typography>
											<Typography className={'option-data'}>{property?.propertySeat}</Typography>
										</Stack>
									</Stack>
									<Stack className={'option'}>
										<Stack className={'svg-box'}>
									...
									<Stack className={'option'}>
										<Stack className={'svg-box'}>
										<img src={'/img/icons/moshina1.png'} />
										</Stack>
										<Stack className={'option-includes'}>
											<Typography className={'title'}>Km</Typography>
											<Typography className={'option-data'}>{property?.propertySize} km</Typography>
										</Stack>
									</Stack>
									<Stack className={'option'}>
										<Stack className={'svg-box'}>
										<img src={'/img/icons/moshina.png'} />
										</Stack>
										<Stack className={'option-includes'}>
									...
									<Stack className={'bottom'}>
										...
										<Stack className={'info-box'}>
											<Stack className={'left'}>
												...
												<Box component={'div'} className={'info'}>
													<Typography className={'title'}>Km</Typography>
													<Typography className={'data'}>{property?.propertySize} km</Typography>
												</Box>
												<Box component={'div'} className={'info'}>
													<Typography className={'title'}>Seat</Typography>
													<Typography className={'data'}>{property?.propertySeat}</Typography>
												</Box>
												{/* <Box component={'div'} className={'info'}>
...
function setDestinationProperties(list: any) {
